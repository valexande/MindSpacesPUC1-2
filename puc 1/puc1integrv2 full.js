...
const GRAPHDB_BASE_URL = "http://160.40.52.59:8200", 
    GRAPHDB_REPOSITORY = "integrpuc1", 
    GRAPHDB_USERNAME = "admin", 
    GRAPHDB_PASSWORD = "alextest", 
    GRAPHDB_CONTEXT_TEST = "http://160.40.52.59:8200/repositories";
...
const DEFAULT_PREFIXES = [
    ...
    {
        prefix: " ",
        iri: "http://www.semanticweb.org/estathop/ontologies/2021/9/untitled-ontology-17#",
    }
];
...
function storeImageabilityResponse(call, callback) {
   ...
   axios.post('http://160.40.52.59:8200/rest/login/admin', null, {
        ...
        const payload = new GetQueryPayload()
          .setQuery('PREFIX owl: <http://www.w3.org/2002/07/owl#> PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> PREFIX : <http://www.semanticweb.org/estathop/ontologies/2021/9/untitled-ontology-17#> ask {:' + element.meta_body.id.replace(/ /g, "_") + ' rdf:type :Image}')
        ...
        if (data._readableState.length == 4){
            console.log(element.meta_body.id.replace(/ /g, "_") + " instance exists in the ontology");
            var state = true;
            ...
            graphDBEndpoint
              .update('delete {?o1 ?r2 ?o2} where {:' + element.meta_body.id.replace(/ /g, "_") + ' ?r ?t. ?t ?r1 ?o1. ?o1 ?r2 ?o2}')
              .then((result) => {
                console.log("The data were deleted level 3");
              })
              .catch((err) => {
                console.log(err);
              });
            ...
            graphDBEndpoint
              .update('delete {?t ?r1 ?o1} where {:' + element.meta_body.id.replace(/ /g, "_") + ' ?r ?t. ?t ?r1 ?o1.}')
              .then((result) => {
                console.log("The data were deleted level 2");
              })
              .catch((err) => {
                console.log(err);
              });
            ...
            graphDBEndpoint
              .update('delete where {:' + element.meta_body.id.replace(/ /g, "_") + ' ?r ?t.}')
              .then((result) => {
                console.log("The data were deleted level 1");
              })
              .catch((err) => {
                console.log(err);
              });
        ...
        {
            console.log(element.meta_body.id.replace(/ /g, "_") + " instance does not exists in the ontology")
            var state = false;
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                String.prototype.replaceAll = function(str1, str2, ignore) 
